...
namespace OpenGLPractice.Milkshake
{
    public class Character : MilkshapeModel
    {
        ...
        private void LoadConfigFile(string filename)
        {
            ...
            base.model_data.Animations = (Animation[])animations.ToArray();
        }
    ...
    public class AnimationCollection : IList
    {
        ...
        public Animation this[string name]
        {
            get
            {
                ...
                {
                    if (((Animation)items[i]).Name.ToLower() == name.ToLower())
                        return (Animation)items[i];
                }
                return null;
            }
            set
